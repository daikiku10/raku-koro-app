...
describe('TodayPcr', () => {
  test(`renders TodayPcr component`, () => {
    ...
    expect(screen.getAllByRole('heading')[1].textContent).toBe('10.00%');
    expect(screen.getAllByRole('heading')[2].textContent).toBe('前日：20.00%');
    expect(screen.getAllByRole('heading')[3].textContent).toBe('前々日：30.00%');
  });
